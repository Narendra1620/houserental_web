    ...
    //upload drap & drop ,remove photos
    ...
    try{
        ...
        listingForm.append("highlight",formDescription.highlightDesc)
    ...
    return (
        ...
        <div className="create-listing">
            ...
            <div className="create-listing_step2">
                ...
                <Droppable droppableId="photos" direction="horizantal">
                    {(provided) => (
                    <div
                        className="photos"
                ...
                <p>Title</p>
                <input type="text" name="title" value={formDescription.title} onChange={handleChangeDescription} placeholder="Title" required />
                <p>Description</p>
                <textarea
                    type="text"
                    name="description"
